...
if __name__ == "__main__":
    ...
    updater = Updater(token="1201225781:AAHk29oWLYFPCbOYGCgahjafJoAJ37dKITY", use_context=True)
    ...
    j = updater.job_queue
    job_thirty_min = j.run_repeating(check_feeds, interval=43200, first=0)
